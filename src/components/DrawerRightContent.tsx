  ...
  return (
    <div className="overflow-y-auto">
      ...
      <div className="flex gap-2 items-start mb-10">
        ...
        <div>
          <h2 className="text-md font-semibold">Veri Girişi Yapılmamış</h2>
          <h4 className="text-xs text-gray-400">Bugün</h4>
        </div>
      </div>
      ...
      <div className="flex gap-2 items-start mb-10">
        ...
        <div>
          <h2 className="text-md font-semibold">Gebelik Teşhisi : 24 Numara</h2>
          <h4 className="text-xs text-gray-400">2 saat önce</h4>
        </div>
      </div>
